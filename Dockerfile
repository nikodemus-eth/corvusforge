# Corvusforge v0.3.0 — Multi-stage, minimal, SAOE-ready
# Build: docker build -t corvusforge:0.3.0 .
# Run:   docker run -p 8501:8501 corvusforge:0.3.0
...
# Install the wheel
COPY . .
RUN pip install --no-cache-dir dist/corvusforge-0.3.0-py3-none-any.whl
